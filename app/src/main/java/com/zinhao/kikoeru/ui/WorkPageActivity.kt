...
class WorkPageActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewmodel:WorksViewModel = ViewModelProvider(this)[WorksViewModel::class.java]
        ...
        val tabTitles = arrayListOf<String>(getString(R.string.all_works),getString(R.string.listening),
            getString(R.string.listened),getString(R.string.marked),getString(R.string.replay),getString(R.string.postponed),)
